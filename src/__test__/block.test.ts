...
describe('Block class', () => {
  ...
  describe('Constructor', () => {
    ...
    it('should aptly save arguments, without previousHash', () => {
      const blockWithoutPreviousHash = new Block(2, 2, Date.now(), { amount: 20 });
      expect(blockWithoutPreviousHash.index).toBe(2);
      expect(blockWithoutPreviousHash.nonce).toBe(2);
  ...
  describe('hashBlock', () => {
    ...
    it('should correctly hash block with SHA256', () => {
      ...
      ).toEqual('7040984f81cd3152d7ac1588a8e19172944fe0cfde161ea0c9c3cee56483823f');
    });
